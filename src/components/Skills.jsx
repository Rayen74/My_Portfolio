...
const Skills = () => {
  ...
  // Disable right-click context menu for Skills component
  useEffect(() => {
    ...
    // Add event listener to the component container
  ...
  return (
    <section 
      className="relative px-4 py-20 overflow-hidden bg-gray-900 skills-section"
    ...
    >
      <style>
        {`
          ...
          /* Allow text selection for description text only */
          .skills-section p, 
          .skills-section span:not(.no-select), 
          .skills-section li {
            ...
            {visibleCerts.map((cert, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <span 
                    className="inline-block px-3 py-1 mt-4 text-xs font-medium text-pink-400 transition-all duration-300 border rounded-full bg-pink-500/10 border-pink-500/30 hover:bg-pink-500/20 hover:shadow-pink-500/20 hover:shadow-lg"
                    onContextMenu={preventContextMenu}
                  >
                    {cert.date}
                  </span>
